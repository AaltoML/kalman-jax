...
inf_method = approx_inf.StatisticallyLinearisedEP(power=0.1, intmethod='GH', damping=0.5)
...
plt.xlim(x_pred[0], x_pred[-1])
plt.title('SLEP: $f^{(1)}$ (mean component)')
# plt.xlabel('Time (milliseconds)')
plt.ylabel('Accelerometer reading')
...
if save_tikz:
    tikzplotlib.save('/Users/wilkinw1/postdoc/inprogress/linearised-inference/paper/fig/mcycle_slep_f1.tex',
                     axis_width='\\figurewidth',
                     axis_height='\\figureheight',
                     tex_relative_path_to_data='./fig/')
...
plt.xlim(x_pred[0], x_pred[-1])
plt.title('SLEP: $\phi(f^{(2)})$ (noise standard deviation component)')
# plt.xlabel('Time (milliseconds)')
plt.ylabel('\phantom{Accelerometer reading}')
ax3.tick_params(axis="y", direction="in")
ax3.tick_params(axis="x", direction="in")
ax3.tick_params(top=True, right=True)
plt.ylim([0., 80.])
if save_tikz:
    tikzplotlib.save('/Users/wilkinw1/postdoc/inprogress/linearised-inference/paper/fig/mcycle_slep_f2.tex',
                     axis_width='\\figurewidth',
                     axis_height='\\figureheight',
                     tex_relative_path_to_data='./fig/')
...
if save_tikz:
    tikzplotlib.save('/Users/wilkinw1/postdoc/inprogress/linearised-inference/paper/fig/mcycle_slep_combined.tex',
                     axis_width='\\figurewidth',
                     axis_height='\\figureheight',
                     tex_relative_path_to_data='./fig/')
